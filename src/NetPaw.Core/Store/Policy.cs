...
{
    public static readonly Policy None = new(null, null, null, [], true, true, true, true, true, true, true, true, true, true, new HashSet<string>());
    ...
    public static readonly string[] Keys = ["WorkAdapter", "PanelHotkey", "ConfirmBeforeApply", "RepoUrls", "AllowUserProfiles", "AllowUserRepos", "AllowReach", "AllowTempAddresses", "AllowDhcp", "AllowUnsignedRepos", "AllowTelemetry", "AllowAutoSwitch", "AllowScan", "AllowCapture"];
}
...
public static class PolicyReader
{
    public static Policy Read(IPolicySource src)
    {
        ...
        return new Policy(S("WorkAdapter"), S("PanelHotkey"), B("ConfirmBeforeApply"), urls?.Where(u => !string.IsNullOrWhiteSpace(u)).ToList() ?? [],
            Allow("AllowUserProfiles"), Allow("AllowUserRepos"), Allow("AllowReach"), Allow("AllowTempAddresses"), Allow("AllowDhcp"), Allow("AllowUnsignedRepos"), Allow("AllowTelemetry"), Allow("AllowAutoSwitch"), Allow("AllowScan"), Allow("AllowCapture"), set);
    }
